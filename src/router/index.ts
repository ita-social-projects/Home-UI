...
import ManagementOfTariffs from '@/finance/components/ManagementOfTariffs.vue';
...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: RoutesEnum.ManagementOfTariffs,
        name: 'management-of-tariffs',
        component: ManagementOfTariffs,
        meta: {
